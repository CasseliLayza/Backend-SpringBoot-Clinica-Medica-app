package com.backend.clinica.security.filter;
...
import static com.backend.clinica.security.filter.TokenJstConfig.*;
...
public class JwtAuthenticationFilter extends
    ...
    public Authentication attemptAuthentication(
        ...
        try {
            usuario = new ObjectMapper().readValue(
    ...
    protected void successfulAuthentication(
        ...
        Collection<? extends GrantedAuthority> roles = authResult
                .getAuthorities();
        ...
        response.addHeader(HEADER_AUTHORIZATION,
                "Bearer " + token);
